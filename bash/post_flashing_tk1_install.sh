...
sudo apt-get install samba # for networked drives
sudo apt-get install tmux # tmux for splitting terminal into panes
...
sudo apt-get install cmake-curses-gui # for cmake configuration of IMU
